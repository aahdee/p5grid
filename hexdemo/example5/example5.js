...
function draw()
{
  ...
  for (var i = 0; i < hexes.length; i++)
  {
    ...
    //print(alpha);
    if (hex.q % 2 == 0 && hex.s % 2 == 0) hexDraw(mainLayout, hex, color(246, 244,210,alpha));
  ...
  for (var i = 0; i < hexes3.length; i++)
  {
    ...
    if (hex.q % 2 == 0 && hex.s % 2 == 0) hexDraw(mainLayout3, hex, '#CDD895')
  }

  stroke('#F19C79');
  for (var i = 0; i < hexes.length; i++)
  {
    if (hexes2[i].q == 0 && hexes2[i].r == 0 && hexes2[i].s == 0) hexDraw(mainLayout2, hexes2[i], '#FFFBB5');
    else if (hexes2[i].q % 2 == 0 && hexes2[i].s % 2 == 0) hexDraw(mainLayout2, hexes2[i], '#D4E09B');
  }
  pop();
